                ...
                return (
                  <div key={provider.name}>
                    <button
                      ...
                      className="w-full flex flex-row gap-2 tracking-tight leading-tight font-semibold justify-center items-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      {' '}
