    ...
    <Container title="About - Hrishikesh Jangir">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full">
        ...
        <div className="mb-8 prose dark:prose-dark leading-6">
          ...
          <h2>Bio</h2>
          <h3>Job Title</h3>
          <p>Hrishikesh Jangir, VP of Developer Experience at Vercel</p>
          <h3>Long, 3rd Person</h3>
          <p>
            Hrishikesh Jangir is the VP of Developer Experience at{' '}
          ...
          <h3>Education</h3>
          <p>
            Hrishikesh Jangir graduated from Iowa State University with a B.S.
