export const homeData = {
  hero: {
    ...
    dashboard: {
      text: 'Dev Dashboard',
      url: '//heimdall.roeintheglasses.dev',
    },
    avatar: {
      src: '/avatar.png',
