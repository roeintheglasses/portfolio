export const workEx = {
  adpushup: {
    role: 'SDE',
    company: 'Adpushup',
    companylogo: require('../public/static/images/companies/Adpushup.jpg'),
    color: '#ff4954',
  ...
  quikieApps: {
    role: 'SDE',
    company: 'Quikie Apps',
    companylogo: require('../public/static/images/companies/quikieApps.jpg'),
    color: '#6fc8e8',
  ...
  safe: {
    ...
    companylogo: require('../public/static/images/companies/safe.jpg'),
    color: '#141c4a',
