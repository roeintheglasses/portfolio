    ...
    <div className="w-full bg-transparent font-sans" ref={containerRef}>
      <div className="max-w-7xl mx-auto pt-10">
        ...
        <p className="text-gray-700 text-lg dark:text-gray-300 mb-2">
          From cybersecurity testing to leading engineering teams, my journey
          spans AI-driven ad-tech platforms, video advertising innovation, and
          fullstack development. I&apos;ve built scalable systems serving
          millions, led cross-functional teams, and specialized in revenue
          optimization technologies that help customers maximize their
          potential.
        </p>
      </div>
