...
const ThemeChange = () => {
  ...
  return (
    <div className="ml-1 cursor-pointer rounded-xl bg-zinc-300 ring-zinc-400 transition-all hover:bg-zinc-300 dark:bg-zinc-700 dark:ring-white dark:hover:bg-zinc-800">
      <motion.button
